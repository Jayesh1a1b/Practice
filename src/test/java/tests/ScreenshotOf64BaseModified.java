...
public class ScreenshotOf64BaseModified {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    String destpath = takeScreenshot("kiteHomePage");//call method and store destpath
	    
	    ExtentTest test = extent.createTest("Test one");
		   test.log(Status.INFO, "Chrome browser launch");
		   String destpath1  = takeScreenshot("HomePage");//call method 2nd time parameter change
		   test.addScreenCaptureFromPath(destpath1);
	...
	//seprate code for screenshot 
public static String takeScreenshot(String filename) throws IOException
{
	 String Base64Screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.BASE64);
	   String destpath=System.getProperty("user.dir")+"\\Screenshots\\"+filename+".png";  //Screenshots folder create manually in these type
